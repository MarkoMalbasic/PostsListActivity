 ...
 */
public class RoseWineFragment extends BaseFragment {

    private View roseWineView;
    private RecyclerView roseWineList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        roseWineView = inflater.inflate(R.layout.fragment_rose_wine, container, false);

        roseWineList = roseWineView.findViewById(R.id.roseWineRVList);
        roseWineList.setLayoutManager(new LinearLayoutManager(getContext()));


        databaseOpenHelper = new DatabaseOpenHelper(getContext());

        //Get product list in db when db exists
        list = databaseOpenHelper.getRoseWine();
        //Init adapter
        itemsAdapter = new ItemsAdapter(getContext(), list);
        //Set adapter for listview
        roseWineList.setAdapter(itemsAdapter);
